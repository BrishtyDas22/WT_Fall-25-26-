...
<body>
    <img src="../IMAGE/3d-house.png" alt="Home Logo" width="60px" height="60px" id="home_logo" onclick="location.href='frontpage.php'">

    <form id="form1" method="post">
        <img src="../IMAGE/11879738.png" alt="registration" width="60px" height= "50px" id="regimage">
        <center>
